...
object AntSpeciesRegistry {
  ...
  val speciesPlains = new Species(Registry.PLAINS, 0x162308, 0x406618, "Antus Fieldia", Map(Biomes.PLAINS → 1f))
  ...
  val speciesStone = new Species(Registry.STONE, 0x2B2B2B, 0x636363, "Formicidae Lapidus")
